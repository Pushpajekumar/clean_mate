        ...
        <Icon name='star' size={20} color="gray" /> 
          ...
          <Text style={styles.numberOfRating}>(9.6k)</Text>
            ...
            <View style={styles.desc1}>
                   <Icon name='circle' size={8} color="gray" /> 
                    <Text style={{marginHorizontal: 10, color: "gray"}}> India, officially the Republic of India (Hindi: Bhārat Gaṇarājya),[26] is a country in South Asia. It is the seventh-largest country  </Text>
                </View>
                <Pressable onPress={onpress} style={styles.viewdetails}><Text style={styles.viewdetailsText}> View Details</Text></Pressable>
